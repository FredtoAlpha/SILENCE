...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DdT8GJ8n.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				children: "Une page s’est perdue"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "max-w-md text-sm leading-relaxed break-words text-fg-muted",
				children: error.message || "Une erreur inattendue s’est produite. Recharge la page."
			})
		]
	});
}
...
var useProgress = create()(persist((set, get) => ({
	...
	markOpened: (slug, id) => set({
		lastSlug: slug,
		openedAt: Date.now(),
		completed: get().completed.includes(id) ? get().completed : get().completed
	}),
	markCompleted: (id) => set((s) => ({ completed: s.completed.includes(id) ? s.completed : [...s.completed, id].sort((a, b) => a - b) })),
	reset: () => set({
		lastSlug: null,
		completed: [],
		openedAt: null
...
var styles_default = "/assets/styles-8BH4ipKM.css";
var APP_NAME = "Le prix du sucre";
var Route$7 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Nouvelle historique en six soirs. Bordeaux, 1768. Deux navires, un même sucre."
			}
		],
		links: [
			{
	...
	component: () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeRoot, {}),
...
var $$splitComponentImporter$5 = () => import("./routes-CPGbO7sZ.mjs");
var Route$6 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
var $$splitComponentImporter$4 = () => import("./carte-Bb0J6GUG.mjs");
var Route$5 = createFileRoute("/carte")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./fin-0HQGXdZQ.mjs");
var Route$4 = createFileRoute("/fin")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./login-C-0CPLi2.mjs");
var Route$3 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./sommaire-DhSLPQL-.mjs");
var Route$2 = createFileRoute("/sommaire")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitNotFoundComponentImporter = () => import("./lire._slug-CCYNmVQe.mjs");
var $$splitComponentImporter = () => import("./lire._slug-B7PcKmqE.mjs");
var Route$1 = createFileRoute("/lire/$slug")({
...
var rootRouteChildren = {
	...
	CarteRoute: Route$5.update({
		id: "/carte",
		path: "/carte",
		getParentRoute: () => Route$7
	}),
	FinRoute: Route$4.update({
		id: "/fin",
		path: "/fin",
		getParentRoute: () => Route$7
	}),
	...
	SommaireRoute: Route$2.update({
		id: "/sommaire",
		path: "/sommaire",
		getParentRoute: () => Route$7
	}),
	LireSlugRoute: Route$1.update({
		id: "/lire/$slug",
		path: "/lire/$slug",
		getParentRoute: () => Route$7
	}),
...
//#endregion
export { getBaseURL as a, PACKAGE_VERSION as i, GROK_PROVIDERS as n, Route$1 as o, GENERIC_OAUTH_ERROR_CODES as r, useProgress as s, router_exports as t };
